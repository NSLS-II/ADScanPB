 ...
 *
 * This file contains the definitions of PV params, and the definition of the ADScanSim class and
 * functions.
 *
...
#define ADScanSim_ExtTriggerEdgeString "TRIG_EDGE"
#define ADScanSim_ExtTriggerSourceString "TRIG_SOURCE"
#define ADScanSim_ExtTriggerSignalString "TRIG_SIGNAL"
...
typedef enum {
    ADSCANSIM_TRIG_INTERNAL = 0,
    ADSCANSIM_TRIG_EDGE = 1,
    ADSCANSIM_TRIG_GATE = 2,
} ADScanSimTrigMode_t;

typedef enum { ADSCANSIM_EDGE_RISING = 1, ADSCANSIM_EDGE_FALLING = 0 } ADScanSimTrigEdge_t;
...
#define ADSCANSIM_FIRST_PARAM ADScanSim_PlaybackRateFPS
    ...
    int ADScanSim_ExtTriggerSource;
    int ADScanSim_ExtTriggerSignal;
    int ADScanSim_ExtTriggerEdge;
